...
const JobUpdateForm = () => {
    ...
    const onSubmit = async (data: any, jobId: string | undefined) => {
        setLoading(true);
        const bigData = {
            ...data,
        ...
        try {
            await axios.put(`${import.meta.env.VITE_BASE_URI}/job/${jobId}`, bigData, {
                headers: {
            ...
            toast({
                title: "Job Updated",
                description: "Your job details  have been updated successfully.",
            });
    ...
    return (
        <div className="flex flex-col items-center mt-5 w-full h-full">
            <Form {...form}>
                <form
                    onSubmit={form.handleSubmit((data) => onSubmit(data, job._id))}
